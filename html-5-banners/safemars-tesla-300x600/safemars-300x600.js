...
lib.ssMetadata = [
		{name:"safemars_300x600_atlas_", frames: [[147,718,228,80],[147,636,228,80],[0,800,228,80],[230,800,228,80],[377,636,115,150],[0,636,145,150],[309,384,150,140],[0,534,421,100],[0,232,307,300],[309,232,159,150],[0,0,504,230]]}
];
...
(lib.tesla3_Layer_2 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#DADADA").s().p("AA6B1IgQgwIhTAAIgQAwIg0AAIBXjpIAsAAIBYDpgAgcAeIA5AAIgdhXg");
	this.shape.setTransform(143.875,-59.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#DADADA").s().p("AAvB1IhdiZIAACZIgwAAIAAjpIAwAAIBdCaIAAiaIAwAAIAADpg");
	this.shape_1.setTransform(113,-59.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#DADADA").s().p("AgXB1IAAjpIAvAAIAADpg");
	this.shape_2.setTransform(96.6,-59.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#DADADA").s().p("AAnB1IgnicIglCcIgwAAIg1jpIAwAAIAgClIAnilIAoAAIAmClIAgilIAwAAIg0Dpg");
	this.shape_3.setTransform(77.4,-59.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#DADADA").s().p("");
	this.shape_4.setTransform(221.9,-19.25);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#DADADA").s().p("AgGBfIAAi9IANAAIAAC9g");
	this.shape_5.setTransform(206.1,-19.75);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#DADADA").s().p("");
	this.shape_6.setTransform(196.725,-16.925);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#DADADA").s().p("");
	this.shape_7.setTransform(182.775,-19.625);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#DADADA").s().p("");
	this.shape_8.setTransform(168.975,-16.925);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#DADADA").s().p("ABIBaIABieIhDCeIgLAAIhDidIACCdIgQAAIAAizIAVAAIBBCeIBDieIAUAAIAACzg");
	this.shape_9.setTransform(150.925,-19.25);
	...
	this.shape_10.setTransform(54.2928,-19.3646,1.266,1.266);
...
(lib.tesla3_Layer_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-29,17,0.5409,0.5409);
...
(lib.tesla3_1 = function(mode,startPosition,loop) {
	...
	this.Layer_2.setTransform(105.7,-40.5,1,1,0,0,0,105.7,-40.5);
	...
	this.Layer_1.name = "Layer_1";
	this.Layer_1.parent = this;
	this.Layer_1.setTransform(107.3,79.2,1,1,0,0,0,107.3,79.2);
	this.Layer_1.depth = 0;
	this.Layer_1.isAttachedToCamera = 0
	this.Layer_1.isAttachedToMask = 0
	this.Layer_1.layerDepth = 0
...
}).prototype = getMCSymbolPrototype(lib.tesla3_1, new cjs.Rectangle(-29,-81.4,272.6,222.8), null);
...
(lib.Scene_1_tesla_3 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(156.1,504.15,1,1,0,0,0,106.8,48.2);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:338.1,alpha:1},23,cjs.Ease.quartInOut).wait(45).to({alpha:0},13,cjs.Ease.quartInOut).to({_off:true},1).wait(298));
...
(lib.Scene_1_logo = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:14.2,scaleX:1,scaleY:1,y:84.2},23,cjs.Ease.quartInOut).wait(332).to({regY:14.3,scaleX:1.2868,scaleY:1.2868,y:244.1},24,cjs.Ease.quartInOut).wait(1));
...
(lib.Scene_1_cta_2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.cta2).wait(187).to({_off:false},0).to({y:458.85},24,cjs.Ease.quartInOut).wait(140).to({y:646.85},24,cjs.Ease.quartInOut).wait(5));
...
(lib.Scene_1_cta_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.cta1).wait(187).to({_off:false},0).to({y:479.25},24,cjs.Ease.quartInOut).wait(140).to({y:667.25},24,cjs.Ease.quartInOut).wait(5));
...
(lib.Scene_1_rocketship = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.rocket).wait(184).to({_off:false},0).to({y:473},24,cjs.Ease.quartInOut).to({y:487},140).to({y:-101.75},24,cjs.Ease.quartIn).wait(8));
...
(lib.Scene_1_planet_mars = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.planet).wait(68).to({_off:false},0).to({y:300.45,alpha:1},23,cjs.Ease.quartInOut).wait(262).to({y:490.45,alpha:0},24,cjs.Ease.quartInOut).wait(3));
...
(lib.safemars300x600 = function(mode,startPosition,loop) {
	...
	this.tesla_3.setTransform(156.6,491.2,1,1,0,0,0,156.6,491.2);
