...
lib.ssMetadata = [
		{name:"safemars_160x600_atlas_", frames: [[147,736,228,80],[0,888,228,80],[230,818,228,80],[230,900,228,80],[262,534,115,150],[0,736,145,150],[309,384,150,140],[0,534,260,200],[0,232,307,300],[309,232,159,150],[0,0,504,230]]}
];
...
(lib.tesla3_Layer_2 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#DADADA").s().p("AA2BsIgPgsIhNAAIgPAsIgvAAIBQjXIAoAAIBRDXgAgaAcIA1AAIgbhQg");
	this.shape.setTransform(100.65,-106.225);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#DADADA").s().p("AArBsIhViNIAACNIgtAAIAAjXIAtAAIBVCOIAAiOIAtAAIAADXg");
	this.shape_1.setTransform(72.1,-106.225);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#DADADA").s().p("AgVBsIAAjXIArAAIAADXg");
	this.shape_2.setTransform(56.875,-106.225);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#DADADA").s().p("AAjBsIgjiQIgiCQIgtAAIgwjXIAsAAIAeCZIAjiZIAlAAIAkCZIAdiZIAsAAIgwDXg");
	this.shape_3.setTransform(39.175,-106.225);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#DADADA").s().p("");
	this.shape_4.setTransform(102.925,-36.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#DADADA").s().p("AgGBYIAAivIANAAIAACvg");
	this.shape_5.setTransform(88.275,-36.875);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#DADADA").s().p("");
	this.shape_6.setTransform(79.675,-34.275);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#DADADA").s().p("");
	this.shape_7.setTransform(66.775,-36.75);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#DADADA").s().p("");
	this.shape_8.setTransform(54,-34.275);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#DADADA").s().p("ABCBTIABiSIg+CSIgKAAIg9iRIABCRIgOAAIAAilIASAAIA9CSIA9iSIATAAIAAClg");
	this.shape_9.setTransform(37.325,-36.425);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#DADADA").s().p("");
	this.shape_10.setTransform(68.425,-67.35);
...
(lib.dollar_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-7,0,0.6,0.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.dollar_1, new cjs.Rectangle(-7,0,90,84), null);
...
(lib.tesla3_1 = function(mode,startPosition,loop) {
	...
	this.Layer_2.setTransform(68.4,-72.5,1,1,0,0,0,68.4,-72.5);
...
}).prototype = getMCSymbolPrototype(lib.tesla3_1, new cjs.Rectangle(0,-126.7,215.3,225), null);
...
(lib.Scene_1_tesla_3 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(120,608.95,1,1,0,0,0,106.8,48.2);
	this.instance.alpha = 0;
	this.instance.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-20, -10, 0, 0))];
	this.instance.cache(-2,-129,219,229);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:388.95,alpha:1},23,cjs.Ease.quartInOut).wait(45).to({alpha:0},13,cjs.Ease.quartInOut).to({_off:true},1).wait(298));
...
(lib.Scene_1_logo = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:43.1,scaleX:1,scaleY:1,x:80.05,y:79.1},23,cjs.Ease.quartInOut).wait(332).to({regY:43.3,scaleX:1.2868,scaleY:1.2868,x:80.1,y:281.4},24,cjs.Ease.quartInOut).wait(1));
...
(lib.Scene_1_cta_2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.cta2).wait(187).to({_off:false},0).to({y:534.85},24,cjs.Ease.quartInOut).wait(140).to({y:646.85},24,cjs.Ease.quartInOut).wait(5));
...
(lib.Scene_1_cta_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.cta1).wait(187).to({_off:false},0).to({y:450.75},24,cjs.Ease.quartInOut).wait(140).to({y:667.25},24,cjs.Ease.quartInOut).wait(5));
...
p.nominalBounds = new cjs.Rectangle(-72,0,266.8,142.9);
...
(lib.Scene_1_rocketship = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.rocket).wait(184).to({_off:false},0).to({y:507},24,cjs.Ease.quartInOut).to({y:504},140).to({y:-101.75},24,cjs.Ease.quartIn).wait(8));
...
(lib.Scene_1_planet_mars = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.planet).wait(68).to({_off:false},0).to({regX:62.9,regY:64.5,scaleX:1.3251,scaleY:1.325,x:77.85,y:300.45,alpha:1},23,cjs.Ease.quartInOut).wait(262).to({regX:63,regY:64.3,scaleX:1.0954,scaleY:1.0954,x:80.8,y:490.45,alpha:0},24,cjs.Ease.quartInOut).wait(3));
...
(lib.safemars160x600 = function(mode,startPosition,loop) {
	...
	this.tesla_3.setTransform(120.9,551.4,1,1,0,0,0,120.9,551.4);
