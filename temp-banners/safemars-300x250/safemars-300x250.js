...
lib.ssMetadata = [
		{name:"safemars_300x250_atlas_", frames: [[759,0,228,80],[718,234,228,80],[309,152,228,80],[539,152,228,80],[769,82,115,150],[470,0,145,150],[617,0,140,150],[0,302,716,100],[0,0,307,300],[309,0,159,150]]}
];
...
(lib.Scene_1_logo = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(23).to({regY:14.2,scaleX:1,scaleY:1,y:28.1},23,cjs.Ease.quartInOut).wait(264).to({regY:14.3,scaleX:1.2868,scaleY:1.2868,y:125.1},24,cjs.Ease.quartInOut).wait(1));
...
(lib.Scene_1_cta_2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.cta2).wait(142).to({_off:false},0).to({y:192.85},24,cjs.Ease.quartInOut).wait(140).to({y:296.85},24,cjs.Ease.quartInOut).wait(5));
...
(lib.Scene_1_cta_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.cta1).wait(142).to({_off:false},0).to({y:213.25},24,cjs.Ease.quartInOut).wait(140).to({y:317.25},24,cjs.Ease.quartInOut).wait(5));
...
(lib.planet_1 = function(mode,startPosition,loop) {
	...
	this.right.setTransform(164.3,76.8,1,1,0,0,0,164.3,76.8);
	this.right.depth = 0;
...
(lib.Scene_1_rocketship = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.rocket).wait(139).to({_off:false},0).to({y:221},24,cjs.Ease.quartInOut).wait(140).to({y:-101.75},24,cjs.Ease.quartIn).wait(8));
...
p.nominalBounds = new cjs.Rectangle(135.9,1.3,179.49999999999997,351.5);
// library properties:
lib.properties = {
